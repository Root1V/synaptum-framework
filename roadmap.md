...
| SYN-74 | `EN CURSO` | **Publicar en un índice** | `1.0.0rc1` **publicado y verificado en TestPyPI**: instalado desde el índice en un entorno limpio, con salida tipada, `py.typed` y cero dependencias. Automatizado con **Trusted Publishing (OIDC)** — no hay token en ninguna parte, así que el secreto no está mejor guardado: no existe. Falta la decisión de publicar en PyPI, que reserva el nombre de forma permanente |
